...
## Requirements
- The root package `github.com/glenngillen/expectedload` keeps its current public API: `Syntax` constants, `ParseComment`, `ExpectedLoad`, `Diagnostic`, `Severity`. No breaking changes.
...
- [ ] A consumer importing `github.com/glenngillen/expectedload` alone builds without linking go-plugin/grpc code.
